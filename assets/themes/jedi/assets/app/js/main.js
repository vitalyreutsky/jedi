...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _functions_form_validate_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../functions/form-validate.js */ "./src/js/functions/form-validate.js");

const form = document.querySelector(".form");
if (form) {
  form.addEventListener("submit", _functions_form_validate_js__WEBPACK_IMPORTED_MODULE_0__.formValidate);
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const handleScroll = () => {
    let foundSection = Array.from(contentBlocks).find(section => section.getBoundingClientRect().top < offsetTop && section.getBoundingClientRect().bottom > offsetTop);
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Keyboard, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation]);
const hero = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".hero__images", {
  slidesPerView: 1,
  slidesPerGroup: 1,
  spaceBetween: 10,
  speed: 1000,
...
/***/ "./src/js/functions/form-validate.js":
/*!*******************************************!*\
  !*** ./src/js/functions/form-validate.js ***!
  \*******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
function formValidate(e) {
  ...
  if (nameValue === "" || !nameRegex.test(nameValue)) {
    ...
    nameError.textContent = nameValue === "" ? "Name is required" : "The name must contain only letters";
    isValid = false;
  } else {
  ...
  if (emailValue === "" || !emailRegex.test(emailValue)) {
    ...
    emailError.textContent = emailValue === "" ? "Email is required" : "Enter a valid email address";
    isValid = false;
  } else {
