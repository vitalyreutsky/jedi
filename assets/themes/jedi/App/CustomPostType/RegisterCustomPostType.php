...
class RegisterCustomPostType
{
    ...
    {
        add_action('init', [self::class, 'registerProjectsType']);
        add_action('init', [self::class, 'register_project_category_taxonomy']);
    }

    public static function registerProjectsType(): void
    {
